...
const deployVendor: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  await goldToken.transfer(vendorAddress, hre.ethers.parseEther("1000"));
  // Transfer contract ownership to your frontend address
  await vendor.transferOwnership("0x816a7a7BfDc923bf9de25E173dCFfAAC169d761C");
};
